...
export default function Contact() {
  ...
  const handleWhatsAppClick = () => {
    const phoneNumber = '254702555075'; // Remove + and spaces
    const message = encodeURIComponent('Hello! I would like to inquire about your automotive services at Kidege Auto Tech.');
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
          ...
          <div className="space-y-6 sm:space-y-8 order-2">
            ...
            {/* WhatsApp Contact */}
            <div className="text-center bg-green-600 rounded-xl p-4 sm:p-6 hover:bg-green-700 transition-colors">
              <button
                onClick={handleWhatsAppClick}
                className="w-full flex flex-col items-center space-y-2 text-white"
              >
                ...
                <div>
                  <h4 className="text-lg sm:text-xl font-bold">WhatsApp Us</h4>
                  <p className="text-green-100 text-sm sm:text-base">Quick response guaranteed</p>
                </div>
              </button>
            </div>
